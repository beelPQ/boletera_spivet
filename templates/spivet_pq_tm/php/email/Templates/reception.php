<?php
    //getTemplateService("Cesar Osgual","Velazquez Alvarez","32133113", "231331132", "111111", "55555555");
    function getTemplateServiceReception($name, $full_name, $email, $phone, $legendSector, $serviceInteresting, $origin){ 
    $date = date("d/m/Y");
    ob_start();
?>
    <!DOCTYPE html>
    ...
    <body>
        <div class="content">
            <div class="content-header">
                <table class="table__header">
                    <tr>
                        ...
                        <td class="td__title"> 
                            <span class="title_header__important">Solicitud de servicio </span>
                        </td>
            ...
            <div class="content-body">
                <table>
                    <tr>
                        <?php if($origin == "servicio"){ ?>
                        <td class="title__email"> <span> Hola Carpey has recibido una nueva solicitud de servicio para <strong> <?php echo $serviceInteresting; ?> <strong>. </span> </td>
                        <?php }else if($origin == "contacto"){ ?>
                            <td class="title__email"> <span> Hola Carpey recibido una nueva solicitud de contato.</span> </td>
                        <?php } ?>
                    </tr>
                    <tr></tr>
                </table>
