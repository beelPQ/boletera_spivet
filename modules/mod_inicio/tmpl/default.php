...
if ($url == '' || $url == null) {
    ...
    $document->addScript('/modules/mod_inicio/tmpl/src/js/inicio.js', array('version' => 'auto'));  
    ...
    $document->addScript('/modules/mod_inicio/tmpl/src/js/oferta.js', array('version' => 'auto'));
