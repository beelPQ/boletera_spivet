...
const validateFormFinal = () => {
    ...
    inputName.forEach(element => { 
       if(element.id == "inputConsFiscal"){
            if(document.querySelector(`#addInvoice_yes`).checked){
                ...
                element.id == "amountIVA" || element.id == "comision" || element.id == "comision_porcentaje" || element.id == "descuento_aplicado" ||
                element.id == "descuento" || element.id == "tipo_descuento" || element.id == "code_descuento" || element.id == "iddescuento"  ){
    ...
    if(noErrors === 0 && noErrorsSelect=== 0 /* && checkAviso.checked */){ 
        ...
        statusErrorForm = 1;
        //console.log(`EERORES ENCONTRADOS`)
  ...
  /*   $(document).ready(function() {
    ...
    const deleteProduct = (btnDelPro) =>{
        ...
        */
        ...
        //console.log('osv_revisando carrito')
        //console.log(JSON.parse(localStorage.getItem(`cart_products`)).length)
    ...
    /**
     * TODO Se agrego esta funcio nque cambia el texto del carrito cuando es contraido o desplegado
     * @param {string} mode 
     */
    ...
    window.addEventListener('click', (e) => {
        ...
        //console.log('osv_click1')
        if( e.target ) {

            let element = e.target;
            let elementID = e.target.id;
            let elementClass = e.target.classList;
            //console.log('osv_click2')
            if(elementClass.contains('deleteProduct')){
                ...
                if(aviso.checked){ 
                    //document.querySelector(`.spinner`).style.display = 'flex';1
                    //console.log('osv_pay1')
                    //proccessPago();
                    //let formData = new FormData();
