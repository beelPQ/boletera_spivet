		...
		public function saveTransaction() {
			...
			try{
				...
				if($response_user['result']=='success'){
					...
					$response_payment = $this->createPayment($response_user['id_client']);

					if($response_payment['result']=='success'){

						$response_payment_items = $this->createPaymentItems($response_user['id_client'],$response_payment['id_cobro']);
