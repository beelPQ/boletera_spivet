            ...
            try {
                ...
                if ($query->affected_rows > 0) {
                    ...
                    if ($previewImage1 != '') {
                        ...
                        // ? Creación de condición para crear la carpeta necesaria [Moroni - 04Jun2024]
                        // Ruta que quieres verificar
                        $ruta = '../../../images/services/';
                        // Verificar si la ruta existe
                        if (!file_exists($ruta)) {
                            // Intentar crear la ruta
                            if (mkdir($ruta, 0777, true)) {
                                // echo "La ruta '$ruta' ha sido creada exitosamente.";
                            } else {
                                // echo "Hubo un error al intentar crear la ruta '$ruta'.";
                            }
                        } else {
