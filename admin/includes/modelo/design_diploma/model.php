<?php
    ...
    class Model{
        ...
        public function createPreviewDocument( $idCourse, $structure, $orientation, $fontFamily ){
            try {
                $con = conectar();
                $nameImage = "";
    ...
    if($_POST){
        ...
        if( $_POST["method"]  == "previewDesignDocument" ){
            $model->createPreviewDocument( $_POST["idCourse"], $_POST["structure"], $_POST["orientation"], $_POST["fontFamily"] );
        }
